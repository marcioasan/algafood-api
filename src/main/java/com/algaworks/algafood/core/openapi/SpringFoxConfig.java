...
//				.paths(PathSelectors.ant("/restaurantes/*"))
	...
	private List<Response> globalGetResponseMessages() {
		  return Arrays.asList(	  
		      new ResponseBuilder()
		          ...
		          .representation(MediaType.APPLICATION_JSON) //18.15. Referenciando modelo de representação de problema com códigos de status de erro - Ver conteúdo de apoio
	...
	//18.15. Referenciando modelo de representação de problema com códigos de status de erro - Ver conteúdo de apoio
